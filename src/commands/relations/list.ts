...
/**
 * List relations in the Directus instance.
 */
export default class RelationsList extends BaseCommand<typeof RelationsList> {
  static override args = {};
  static override description = 'List relations between collections';
  ...
  static override summary = 'List relations';

  public async run(): Promise<void> {
    const {flags} = await this.parse(RelationsList);
    ...
    // readRelations doesn't accept query params in current SDK version
    const sdkCommand = readRelations() as unknown as SdkRestCommand<unknown[]>;
